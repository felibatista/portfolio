...
export function AboutSectionExperience() {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-5 font-bold text-title-sm md:text-title-sm leading-[1.1] mt-[5rem] md:mt-0 ">
      ...
      <p className="mt-6 text-description-sm md:text-description text-center md:text-left">
